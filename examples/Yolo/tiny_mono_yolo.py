...
manipOut.setStreamName("mono")
nnOut.setStreamName("nn")

# Properties
# CHANGE: set image resolution by command line argument
h = int(sys.argv[2])
w = int(sys.argv[3])
...
# camMono.setInterleaved(False)
# camMono.setColorOrder(dai.ColorCameraProperties.ColorOrder.BGR)
camMono.setFps(40)

# convert grayscale frame into nn-acceptable form 
manip.initialConfig.setResize(h, w)
# NN model expects BGR input. By default ImageManip output type would be the same as input(gray scale)
manip.initialConfig.setFrameType(dai.ImgFrame.Type.BGR888p)
# set maxsize
manip.setMaxOutputFrameSize(1400000)
...
detectionNetwork.setAnchorMasks({"side40": [1, 2, 3], "side20": [3, 4, 5]})
